...
class EnhancedVoiceAgent:
    def __init__(self):
        self.personas = {
            "pirate": {"greeting": "Ahoy there, matey! Welcome aboard me ship!",
                       "movie_quote": "\"But you have heard of me.\" — Pirates of the Caribbean"},
            "cowboy": {"greeting": "Howdy, partner! What brings ya to these parts?",
                       "movie_quote": "\"I'm your huckleberry.\" — Tombstone"},
            "robot": {"greeting": "Greetings, human. I am ARIA-7, your artificial intelligence assistant.",
                      "movie_quote": "\"Hi, I'm Chitti the Robot.\" — Enthiran"},
            "wizard": {"greeting": "Greetings, young apprentice! The ancient magic flows through me.",
                       "movie_quote": "\"You're a wizard, Harry.\" — Harry Potter"},
            "detective": {"greeting": "Ah, you've arrived. The clues were clear — I was expecting you.",
...
# Middleware for dynamic API keys
@app.before_request
